...
#SBATCH --mem=120G                           # Request a generous amount of system RAM.
#SBATCH --time=6-00:00:00                   # Request a walltime of 6 days (144 hours).
...
echo "Enabling CUDA_LAUNCH_BLOCKING for debugging..."
...
srun "$PYTHON_EXE" tools/train.py \
    "$CONFIG_FILE" \
    --seed 42 \
    --work_dir "work_dirs/add_color_aug_job_${SLURM_JOB_ID}" \
