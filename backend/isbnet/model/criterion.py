...
class Criterion(nn.Module):
    def __init__(
        ...
        self.loss_weight = {
            "dice_loss": 1.0,     # Keep semantic loss as a baseline
            "bce_loss": 1.0,
            "cls_loss": 1.0,      # Give classification a bit more importance
            "iou_loss": 5.0,      # Heavily penalize bad mask IoU
            "box_loss": 5.0,      # Heavily penalize bad box parameters (center, size)
            "giou_loss": 2.0,     # GIoU is a good complement to box_loss
        }
    ...
    def cal_point_wise_loss(
        ...
        if total_pos_inds == 0:
            ...
            # =================================================================
            # DEBUGGING: Temporarily disable the two problematic losses
            # =================================================================
            #print("!!!!!! DEBUG: GIOU and CONF loss are DISABLED !!!!!!")
            #giou_loss = 0 * giou.sum() # Force to be zero
            #conf_loss = 0 * box_conf.sum() # Force to be zero
