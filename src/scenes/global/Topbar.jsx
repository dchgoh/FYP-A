  ...
  useEffect(() => {
    switch (location.pathname) {
      ...
      case "/potree":
        ...
        break;
      default:
        // Handle dynamic paths like /potree?url=... if necessary
    ...
    // Get username from local storage when component mounts or location changes
    const storedUsername = localStorage.getItem("username");
    if (storedUsername) {
      setUsername(storedUsername);
    } else {
        setUsername(""); // Clear if not found (e.g., after logout)
    }
  }, [location.pathname]);
  ...
  return (
    ...
    >
      ...
      <Box
        ...
        alignItems="center"
        ml="-120px"
        height="100%" // Ensure logo box takes full height
      >
        <img
          src="../../assets/logo.png"
          alt="Company Logo"
          style={{ maxHeight: "80px", maxWidth: "150px" }} //Added max width
        />
      </Box>
