...
const MiniMapContent = ({ files, currentPointCloudUrl, initialCenter, initialZoom, colors }) => {
  const map = useMap();
...
const MiniMap = ({ files = [], currentPointCloudUrl, mapHeight = '250px', mapWidth = '300px', colors }) => {
